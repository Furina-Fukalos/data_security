...
基于浏览器的单页数据安全管理评估工具（Data Security Management Evaluation System）。按照有关指标中的 477 项评估指引，对评估对象进行逐项评估、自动评分与风险源分析，并可导出样式化的 Excel 评估表与文本报告。
